...
// Check if the product ID is provided via URL
if (isset($_GET['id'])) {
    $product_id = $_GET['id'];
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $update_sql = "UPDATE products SET product_name = ?, product_description = ?, price = ?, stock_quantity = ? WHERE id = ?";
        $update_stmt = $conn->prepare($update_sql);
        $update_stmt->bind_param("ssdii", $product_name, $product_description, $price, $stock_quantity, $product_id);

        if ($update_stmt->execute()) {
            $_SESSION['success_message'] = "Product updated successfully!";
            header('Location: product-inventory.php'); // Redirect to the inventory page after successful update
            exit;
        } else {
...
<div class="header">
    ...
    <button class="toggle-btn" id="toggle-btn">☰</button>
        ...
        <br><h2>Update Product Details</h2>


    <div class="card">
        <div class="card-header">Fill in the form :</div>
        <div class="card-body">
            <form method="POST">
                ...
                <a href="product-inventory.php" class="btn btn-secondary ml-2">Cancel</a>
            </form>
        </div>
    </div>
