...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bind_param("ssssi", $username, $email, $password, $role_id, $user_id);
...
<h2 class="card-deck">Edit users details: </h2>
<br>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        toggleBtn.addEventListener("click", function () {
            sidebar.classList.toggle("show"); // Toggle 'show' class for sidebar
            content.classList.toggle("shift"); // Shift content area
        });
    });
</script>
