...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO projects (project_name, project_description, project_start_date, project_due_date, project_status) 
    VALUES ('$project_name', '$project_description', '$start_date', '$due_date', '$project_status')";
...
<body>
    ...
    <div class="card">
        <h3 class="card-header">Fill in the form to generate new project </h3>
        <div class="card-body">
