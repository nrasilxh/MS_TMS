...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        echo "Error updating taskss: " . $stmt->error;
    }
}
...
<button class="toggle-btn" id="toggle-btn">☰</button>
    ...
    <div class="container" id="content"><br>
            <h2 class="card-deck">Update task details :</h2>
            <br>
    ...
    <div class="container">
        <form action="edit-task.php?id=<?php echo $task_id; ?>" method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="task_name" name="task_name" value="<?php echo htmlspecialchars($task['task_name']); ?><?php echo ($_SESSION['role_name'] == 'Production Crew') ? 'readonly' : ''; ?>" required>
            </div>
            <div class="form-group">
                <label for="task_description">Task Description</label>
                <textarea class="form-control" id="task_description" name="task_description" rows="4"><?php echo htmlspecialchars($task['task_description']); ?><?php echo ($_SESSION['role_name'] == 'Production Crew') ? 'readonly' : ''; ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group"><?php if (in_array($_SESSION['role_name'], ['Admin', 'Manager'])): ?>
                <label for="project_id">Project</label>
                <select class="form-control" id="project_id" name="project_id" required>
                    <?php while($project = $projects_result->fetch_assoc()): ?>
                        <option value="<?php echo $project['project_id']; ?>" <?php if($project['project_id'] == $task['project_id']) echo 'selected'; ?>>
