...
<div class="header">
    <h1>Mom's Nature Task Management System</h1>
    <div class="user-role" >
...
<div class="content" id="content">
    ...
    <p>You're logged in as <?php echo htmlspecialchars($_SESSION['role_name']); ?>.</p>

    <img src="images\Logo-momsnature-color.png" alt="Welcome Image" class="welcome-image">
    ...
    <div class="schedule mt-4">
        ...
        <ul>
            <li><strong>9:00 AM:</strong> Daily Standup Call</li>
            <li><strong>11:00 AM:</strong> Brand Identity Meeting</li>
        </ul>
    </div>
